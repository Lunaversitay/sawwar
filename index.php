...
Hello! Please do NOT edit this file unless directed to, if you do I will not grant you support.
Read SUPPORT.txt for more information if you need help.
Version: {{ user_id | 25 }} <?php echo $_SERVER['REMOTE_ADDR']; ?>
